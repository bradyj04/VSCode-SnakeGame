function runGame() {
  //Test if image input field is empty, if it is keep enabled
  if (document.getElementById("nft_url").value == "" || document.getElementById("nft_url").value == null) {
    ...
    //Disables input button if the url is not empty
    ...
    function snakeColor() {
      ...
      else if (randColorCount < 5) {
        //Changes randColorCount back to 0 to allow color change
        randColorCount = randColorCount + 1;
        //If 1, set color to previous color RGBA
        return color;
      }else{
        //Changes randColorCount back to 0 to allow color change
        randColorCount = 0;
        //If 2, set color to previous color RGBA
        return color;
      }
    }
    ...
    function rnd(m) {
      ...
      function loadGame() {
        ...
        //starts game
        //interval changes speed of gamer, higehter number is slower
